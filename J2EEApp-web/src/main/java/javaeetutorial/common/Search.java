...
public class Search {
     ...
     * @return 
     */
    public static HashMap<String,String>  getMovies(String searchString) {
        ...
        try {
            ...
            String queryTerm = getInputQuery(searchString);
         ...
         //  search.setQ("telugu");
            ...
            if (searchResultList != null) {
             moviesMap=prettyPrint(searchResultList.iterator(), queryTerm);
            }
     ...
     */
    private static String getInputQuery(String searchString) throws IOException {
